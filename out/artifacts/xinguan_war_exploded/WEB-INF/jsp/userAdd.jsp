...
<div class="x-body">
    <form class="layui-form">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="number" id="age" name="age" required="" lay-verify="required"
                       autocomplete="off" class="layui-input">
            </div>
            <div class="layui-form-mid layui-word-aux">
                <span class="x-red">*</span>输入年龄
            </div>
        </div>
        <div class="layui-form-item">
            <label for="name" class="layui-form-label">
...
<script>
    layui.use(['form','layer'], function(){
        ...
        form.on('submit(add)', function(data){
            ...
            //希望服务器返回json格式的字符串
            $.ajax({
                url: "${pageContext.request.contextPath}/user/addDone",
                type: "post",
                datatype: "json",
                data: {"name":nameValue,"age":ageValue,"phone":phoneValue,
                    "email":emailValue,"userName":usernameValue,"address":addressValue,
