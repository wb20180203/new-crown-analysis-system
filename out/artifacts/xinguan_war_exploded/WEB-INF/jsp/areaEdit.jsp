...
<div class="x-body">
    <form class="layui-form">
        ...
        <input type="hidden" name="time" value="${areaInfo.time}"/>
        <input type="hidden" name="provinceName" value="${areaInfo.provinceName}"/>
        <div class="layui-form-item">
            <label for="areaName" class="layui-form-label">
                <span class="x-red">*</span>地区名
            </label>
            <div class="layui-input-inline">
                <input type="text" id="areaName" name="areaName" required="" lay-verify="areaName" value="${areaInfo.areaName}"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="number" id="confirmCount" name="confirmCount" required="" lay-verify="confirmCount" value="${areaInfo.confirmCount}"
                       autocomplete="off" class="layui-input">
            </div>
            <div class="layui-form-mid layui-word-aux">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="curedCount" name="curedCount" required="" lay-verify="curedCount" value="${areaInfo.curedCount}"
                       autocomplete="off" class="layui-input">
            </div>
            <div class="layui-form-mid layui-word-aux">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="number" id="deadCount" name="deadCount" required="" lay-verify="deadCount" value="${areaInfo.deadCount}"
                       autocomplete="off" class="layui-input">
            </div>
            <div class="layui-form-mid layui-word-aux">
...
<script>
    layui.use(['form','layer'], function(){
        ...
        form.on('submit(add)', function(data){
            ...
            //希望服务器返回json格式的字符串
            $.ajax({
                url: "${pageContext.request.contextPath}/area/updateOne",
                type: "post",
                datatype: "json",
                data: {"id":idValue,"time":timeValue,"provinceName":provinceValue,"areaName":areaNameValue,"confirmCount":confirmValue,
